...
- (id)initWithFrame:(CGRect)frame {
    ...
    if ((self = [super initWithFrame:frame])) {
        ...
        SVProgressHUDBackgroundColor = [WODConstants.COLOR_DIALOG_BACKGROUND colorWithAlphaComponent:0.5];
        SVProgressHUDForegroundColor = WODConstants.COLOR_TEXT_TITLE;
...
- (void)showProgress:(float)progress status:(NSString*)string maskType:(SVProgressHUDMaskType)hudMaskType {
	...
	SVProgressHUDBackgroundColor = WODConstants.COLOR_DIALOG_BACKGROUND;
	SVProgressHUDForegroundColor = WODConstants.COLOR_TEXT_TITLE;
