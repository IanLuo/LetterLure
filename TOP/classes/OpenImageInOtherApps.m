...
#import "OpenImageInOtherApps.h"

@interface OpenImageInOtherApps()

@end

@implementation OpenImageInOtherApps
...
{
	return NSLocalizedString(@"OPEN_WITH_APP", nil);
}
...
- (UIImage *)activityImage       // default returns nil. subclass must override and must return non-nil value
{
	...
	{
		return [UIImage imageNamed:@"open_in_other_app_activity_76"];
	}
	else if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone)
	{
		return [UIImage imageNamed:@"open_in_other_app_activity_60"];
	}
	else
	{
		return [UIImage imageNamed:@"open_in_other_app_activity_60"];
