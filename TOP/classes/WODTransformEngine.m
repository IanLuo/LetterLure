...
@interface WODTransformEngine()

@end

@implementation WODTransformEngine
{
	// Vectors
    GLKVector3      _right;
    GLKVector3      _up;
...
{
	return GLKMatrix4MakeWithQuaternion(_rotationEnd);
}
...
- (void)restore
{
	_rotationEnd = GLKQuaternionIdentity;
	_scaleEnd = 1.0;
	_translationEnd.x = 0.0;
	_translationEnd.y = 0.0;
}
