...
+ (UIColor *) darkdarkColor {
    return [UIColor colorFromHexCode:@"212225"];
}

+ (UIColor *) darkbrightColor {
    return [UIColor colorFromHexCode:@"413C41"];
}

+ (UIColor *)retroBlue
{
	return [UIColor colorFromHexCode:@"5A82A5"];
}
